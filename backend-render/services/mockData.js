 ...
 * (e.g. local development, or a demo environment). Mirrors the frontend's
 * original Phase 1 mock data so behavior is consistent across environments.
 */
...
function mockFindCustomerByMembershipId(membershipId) {
...
function mockRedeemCustomerReward(membershipId) {
